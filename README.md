...
| AZURE_DNS_LABEL | The dns name label for container group with public IP. | `demo1` |


### Verification
Call the rest api endpoint `[AZURE_DNS_LABEL].[AZURE_LOCATION].azurecontainer.io:[PORT]/demo1`:
```
curl http://demo1.westeurope.westeurope.azurecontainer.io:8080/demo1
```
